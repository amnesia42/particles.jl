...
z0=0.5; N = 1000;Tend = 0.216;scheme="euler";kernel_type="box"
...
for i=1:numTobs
    ...
    for j=1:numdt
        plot!(pall,pdfoutput[j,:,i]/20, linewidth=3, zgrid, xlabel="concentration", ylabel="x",label="num dt=$(dt_list[j])",dpi=300, legend=:left,subplot=i)
    end
